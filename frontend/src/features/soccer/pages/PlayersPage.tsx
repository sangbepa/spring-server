...
export function PlayersPage() {
  ...
  const searchName = useStore((state) => state.searchName);
  const searchPosition = useStore((state) => state.searchPosition);
  const setSearchName = useStore((state) => state.setSearchName);
  const setSearchPosition = useStore((state) => state.setSearchPosition);
  ...
  const handleSearch = () => {
    fetchPlayers(searchName || undefined, searchPosition || undefined);
  };
