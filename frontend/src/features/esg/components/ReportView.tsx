      ...
      <div className="max-w-4xl mx-auto p-8 lg:p-12">
        ...
        <section className="mb-12 bg-white rounded-2xl p-8 shadow-lg border-2 border-emerald-100 hover:shadow-xl transition-shadow">
          ...
          <div className="prose prose-lg max-w-none text-gray-700 space-y-4 leading-relaxed">
            ...
            <p>
              경영진은 위원회에서 승인된 기후 전략을 이행하며, 기후 리스크 식별 및 평가에 대한 책임을
              집니다.
            </p>
          </div>
        </section>
        ...
        <section className="mb-12 bg-white rounded-2xl p-8 shadow-lg border-2 border-emerald-100 hover:shadow-xl transition-shadow">
          ...
          <div className="prose prose-lg max-w-none text-gray-700 space-y-4 leading-relaxed">
            <p>
              당사는 단기, 중기, 장기에 걸쳐 식별된 주요 기후 관련 리스크와 기회를 관리합니다. 주요
              전환 리스크로는 탄소 배출 규제 강화가 있으며, 물리적 리스크로는 극한 기후 현상 증가를
              식별하였습니다.
            </p>
            <p>
              기회 요인으로는 저탄소 제품 및 서비스 시장 확대를 식별하고, 관련 기술 개발에 R&D 투자를
              집중하고 있습니다.
            </p>
          </div>
        </section>
        ...
        <section className="mb-12 bg-white rounded-2xl p-8 shadow-lg border-2 border-emerald-100 hover:shadow-xl transition-shadow">
          ...
          <div className="prose prose-lg max-w-none text-gray-700 space-y-4 leading-relaxed">
            <p>
              당사의 온실가스 배출량은 2023년(기준연도) 대비 2030년까지 Scope 1, 2 배출량을 40%
              감축하는 것을 목표로 합니다.
            </p>
